package me.jessyan.armscomponent.commonsdk.constants;
...
public class Constants {
    ...
    public static final String DATE_FORMAT_TOTAL = DATE_FORMAT_LINE+" HH:mm:ss";
    ...
    public static final  String WANGYI_DOMAIN_NAME = "wangyi";
