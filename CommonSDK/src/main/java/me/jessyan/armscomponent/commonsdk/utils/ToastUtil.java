...
public class ToastUtil {
    ...
    public static void showToast(int type, String s) {
        ...
        if(type==TPYE_SUCCESS){
            titleDrawable = MyApplication.getApplication().getResources().getDrawable(R.drawable.ic_toast_success);
        }else {
            titleDrawable = MyApplication.getApplication().getResources().getDrawable(R.drawable.ic_toast_failure);
        }
