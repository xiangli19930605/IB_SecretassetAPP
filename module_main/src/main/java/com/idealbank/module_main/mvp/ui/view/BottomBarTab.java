package com.idealbank.module_main.mvp.ui.view;
...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.public_color_002cdf));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.public_color_002cdf));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.public_color_b8ddff));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext,R.color.public_color_b8ddff));
        }
    }
