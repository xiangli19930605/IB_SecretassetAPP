 ...
 */
@FragmentScope
public class CurrentInventoryModel extends BaseModel implements CurrentInventoryContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public CurrentInventoryModel(IRepositoryManager repositoryManager) {
