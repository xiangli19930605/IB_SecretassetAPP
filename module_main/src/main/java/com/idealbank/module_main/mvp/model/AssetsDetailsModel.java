 ...
 */
@FragmentScope
public class AssetsDetailsModel extends BaseModel implements AssetsDetailsContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public AssetsDetailsModel(IRepositoryManager repositoryManager) {
