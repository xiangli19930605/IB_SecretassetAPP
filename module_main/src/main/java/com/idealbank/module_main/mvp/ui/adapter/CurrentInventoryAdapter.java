 ...
 * ================================================
 */
public class CurrentInventoryAdapter extends BaseQuickAdapter<TaskBean, BaseViewHolder> {
    private AppComponent mAppComponent;
    private ImageLoader mImageLoader;//用于加载图片的管理类,默认使用 Glide,使用策略模式,可替换框架

    public CurrentInventoryAdapter(@Nullable List data) {
        super(R.layout.item_rv_currentinventory, data);
    }
